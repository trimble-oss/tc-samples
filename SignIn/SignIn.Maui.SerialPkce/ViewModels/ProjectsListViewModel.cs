...
namespace SignIn.Maui.SerialPkce.ViewModels
{
    public partial class ProjectsListViewModel : ObservableObject, IProjectsListViewModel
    {
        ...
        [RelayCommand]
        private async Task DoRefreshProjects()
        {
        ...
        private async Task<byte[]> ImageSourceToByteArray()
        {
            ...
            var imageSource = ImageSource.FromResource("SignIn.Maui.SerialPkce.Resources.Images.no_projects_image.png", assembly);
